...
// ---------------------------------------------------------------------------
	...
	//================Dirubah jan 2024 dari 500 ke 5000
	#define MAX_SENSOR_DISTANCE 500 // 500 Maximum sensor distance can be as high as 500cm, no reason to wait for ping longer than sound takes to travel this distance and back. Default=500
    //================Dirubah jan 2024 dari 57 ke 5.7
	#define US_ROUNDTRIP_CM 57    // 57 Microseconds (uS) it takes sound to travel round-trip 1cm (2cm total), uses integer to save compiled code space. Default=57
